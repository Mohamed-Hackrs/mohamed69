...
LOGS.info(f"⏳ تم استغراق {time_formatter((time.time() - start_time) * 1000)} ميللي ثانية لبدء تشغيل سورس محمد.")

LOGS.info(
    """
    ╔══════════════════════════════════════════╗
    ║       ✅ تم تنصيب وتشغيل سورس محمد بنجاح             ║ 
    ║       تابع آخر التحديثات من خلال قناة @x_7RP_99            ║
    ╚══════════════════════════════════════════╝
    """
)
...
try:
    asst.run()
    LOGS.info(f"تم بنجاح تشغيل البوت المساعد من @x_7RP_99")
