...
from jmthon.decorators import eod, eor
from resources import DEVLIST
from jmthon.helper import inline_mention, get_uinfo
from jmthon import HNDLR
from .. import LOGS, types, mohamed_cmd
...
@mohamed_cmd(pattern="تثبيت$", manager=True, require="pin_messages", fullsudo=True)
async def pin(msg):
    if not msg.is_reply:
